...
public class SellAdapter extends ArrayAdapter<Order> {
    Context myContext;
    int myLayout;
    ...
    public SellAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Order> listOrder) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        SellAdapter.ViewHolder viewHolder = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(myContext).inflate(myLayout, null);
            viewHolder = new SellAdapter.ViewHolder(convertView);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (SellAdapter.ViewHolder) convertView.getTag();
        }
